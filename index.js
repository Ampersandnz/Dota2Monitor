...
server.events.on('newclient', function(client) {
    ...
    //TODO: Separate out the above messages into a separate ability off cooldown function, and pass in the ability object as a parameter

    //TODO: Figure out how many is the maximum number of abilities [fucking injoker] and add support for all of them

    //TODO: Do soemthing with items - cooldowns etc. 

    //TODO: Eventually add in image representations of the inventory, stash, hero, and items.

    //TODO: Add alerts for ward stock coming off cooldown, day/night - pretty much everything that the GSI system supports.
...
http.listen(8081, function() {
    console.log("Ready to send messages to clients on port 8081");
    setupHeroNames();
    setupItemNames();
    setupAbilityNames();
});
